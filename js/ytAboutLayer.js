var ytAboutLayer = (function () {
	...
	ytAboutLayer.prototype.addAboutTxt = function () {
		...
		var txtList = [
			"A: Wien eeft er da stom spel ier gemakt?",
			"Y: Ikke",
			"A: Wien es da ton, ikke??",
			"Y: Ik zin kik veel slimmer dan gie. Mijn naam is EIAAI",
			"A: Wukke? EIAAI wa es da voe name? Poephaai! Da ziede gij",
			"Y: Dit woord staat niet in mijn woordenboek, homo sapiens",
			"A: Wukke? Ik ne homo? Kga ne kji tsop ut jun mulle bokken vint! Od ju mulle."
		];
